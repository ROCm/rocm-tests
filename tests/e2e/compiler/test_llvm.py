...
#   multi_gpu_interleave      -- scenario 5
#   multi_gpu_interleave_seed -- scenario 9
_MULTI_GPU_ARGS = [
    pytest.param(
...
def test_llvm_mem_intrinsic_stress(
    ...
    --buffer-size-2pow=28 (256 MiB) for CI runtime safety.  The binary prints
    '[PASS]' to stdout and exits 0 on success, exits 1 on any mismatch or HIP
    API error.
    """
