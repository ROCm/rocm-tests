...
Provides the CRIU runtime prefix (host and in-target), the cuda_memtest HIP build, and the LLNL
RAJAPerf HIP build, grouped into the COMMON / CUDAMEM / RAJAPERF sections below.
"""
