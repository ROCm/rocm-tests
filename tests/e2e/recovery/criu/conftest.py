...
MNIST checkout, the LLNL RAJAPerf HIP build, and the Kokkos performance-benchmark HIP build,
grouped into the COMMON / CUDAMEM / MNIST / RAJAPERF / KOKKOS sections below.
"""
