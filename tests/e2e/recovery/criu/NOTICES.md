...
The tests under `tests/e2e/recovery/criu/` **fetch, build, and run** several third-party
...
gitignored `output/` build directory (cuda_memtest, Kokkos) or on the test node itself (CRIU).
