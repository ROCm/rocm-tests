...
The underlying `analyze_monitoring` module is stdlib-only and lives in the
same module (``tests.common.gpu_monitored.analyze_monitoring``). It can also be
invoked as a script via ``python3 -m tests.common.gpu_monitored.analyze_monitoring``.
"""
