...
- ``runner._csv_stats`` (per-test text summary)
...
field, only this module needs to change; the earlier layout had three
independent string-literal copies across those modules.
"""
